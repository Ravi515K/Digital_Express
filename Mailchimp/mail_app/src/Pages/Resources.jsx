            ...
            <Box>
                <Box boxSize={"600px"} h="auto" boxShadow={"2xl"}  p="50px" >
                    ...
                    <Box fontSize={"25px"} textAlign="left" mb="30px">
                        <Text mb="30px" ><Link to={"https://mailchimp.com/en-gb/resources/mailchimp-101/"}>Mailchimp 101</Link></Text>
                        <Text mb="30px"><Link to={"https://mailchimp.com/en-gb/help/"}>Help Center</Link></Text>
                        <Text mb="30px"><Link to={"https://mailchimp.com/en-gb/resources/"}>Marketing Library</Link></Text>

                    </Box>
                    <hr style={{height:"5px"} }/>
                    <Text fontSize={"15px"} textAlign="left" mb="30px" color={"GrayText"} mt="30px">Community</Text>
                    <Box fontSize={"25px"} textAlign="left">
                        <Text mb="30px" ><Link to={"https://mailchimp.com/en-gb/audience/"}>For Freelancers & Agencies</Link></Text>
                        <Text mb="30px"><Link to={"https://mailchimp.com/en-gb/create-content/"}>For Developers</Link></Text>
                        <Text mb="30px" ><Link to={"https://mailchimp.com/en-gb/experts/"}>Hire A trusted Partner</Link></Text>
                    </Box>
                </Box>
            </Box>
            </DrawerBody>
