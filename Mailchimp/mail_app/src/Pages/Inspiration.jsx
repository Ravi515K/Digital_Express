...
import { Box,Flex,Spacer,Text, useDisclosure,Button, Heading , Image,Link } from "@chakra-ui/react";
                ...
                <Box>
                    <Box boxSize={"600px"} h="auto"  p="50px" boxShadow={"2xl"} >
                        ...
                        <Box fontSize={"25px"} textAlign="left" mb="30px">
                            <Text mb="30px" ><Link href={"https://mailchimp.com/presents/"}>Mailchimp 101</Link></Text>
                            <Text mb="30px"><Link href={"https://mailchimp.com/presents/"}>Help Center</Link></Text>
                            <Text mb="30px"><Link href={"https://mailchimp.com/presents/"}>Marketing Library</Link></Text>
                        ...
                        <Box fontSize={"25px"} textAlign="left">
                            <Text mb="30px" ><Link href={"https://mailchimp.com/courier/workshop/"}>For Freelancers & Agencies</Link></Text>
                            <Text mb="30px"><Link href={"https://mailchimp.com/courier/briefings/"}>For Developers</Link></Text>
                            <Text mb="30px" ><Link href={"https://mailchimp.com/courier/life/"}>Hire A trusted Partner</Link></Text>
                        </Box>
                    </Box>
                </Box>
            </DrawerBody>
